...
for _, exercise in ipairs(lines) do
  ...
  if attr and attr.mode == "directory" then
    ...
    print(lib.colour_text("Skipping '" .. exercise .. "' as it doesn't appear to be downloaded", "yellow"))
  end
end

print(lib.colour_text(successful .. " out of " .. #lines .. " succeeded", "green"))
if #failures > 0 then
  local s = #failures == 1 and "exercise" or "exercises"
  print(lib.colour_text("The following " .. #failures .. " " .. s .. " failed:", "yellow"))
